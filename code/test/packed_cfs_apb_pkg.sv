...
`ifndef CFS_APB_PKG_SV
  ...
  package cfs_apb_pkg;
    ...
    class cfs_apb_agent_config 
		extends uvm_ext_agent_config#(cfs_apb_vif);
    ...
    class cfs_apb_coverage 
		extends uvm_ext_coverage #(.VIRTUAL_INTF(cfs_apb_vif), .ITEM_MON(cfs_apb_item_mon));
    ...
    class cfs_apb_driver 
		extends uvm_ext_driver#(.VIRTUAL_INTF(cfs_apb_vif), .ITEM_DRV(cfs_apb_item_drv));
    ...
    endclass
		...
		class cfs_apb_sequencer 
			extends uvm_ext_sequencer#(.ITEM_DRV(cfs_apb_item_drv));
    ...
    class cfs_apb_agent 
      extends uvm_ext_agent#(.VIRTUAL_INTF(cfs_apb_vif), .ITEM_DRV(cfs_apb_item_drv), .ITEM_MON(cfs_apb_item_mon));
      ...
      function new(string name = "", uvm_component parent);
        ...
        uvm_ext_agent_config#(.VIRTUAL_INTF(cfs_apb_vif))::type_id::set_inst_override(
          cfs_apb_agent_config::get_type(),
          "agent_config",
          this
        );

        uvm_ext_monitor#(.VIRTUAL_INTF(cfs_apb_vif), .ITEM_MON(cfs_apb_item_mon))::type_id::set_inst_override(
          cfs_apb_monitor::get_type(),
          "monitor",
          this
        );

        uvm_ext_coverage#(.VIRTUAL_INTF(cfs_apb_vif), .ITEM_MON(cfs_apb_item_mon))::type_id::set_inst_override(
          cfs_apb_coverage::get_type(),
          "coverage",
          this
        );

        uvm_ext_driver#(.VIRTUAL_INTF(cfs_apb_vif), .ITEM_DRV(cfs_apb_item_drv))::type_id::set_inst_override(
          cfs_apb_driver::get_type(),
          "driver",
          this
        );
